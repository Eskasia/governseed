...
require(workflow.match(/GIT_AUTHOR_DATE=2026-08-01T00:00:00Z/g)?.length === 2, 'V5 sealed seed author date must be reused exactly');
require(workflow.match(/GIT_COMMITTER_DATE=2026-08-01T00:00:00Z/g)?.length === 2, 'V5 sealed seed committer date must be reused exactly');
