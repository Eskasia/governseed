...
- Ordering constraint: V2 binds its only additional G2 dispatch to exact main `9c83280cec2d9f8fedd15455cfa261680452969f`; therefore no policy, checkpoint, or manifest merge may change main before that dispatch. The OWNER activation binding must first resolve the stale record for authorization accounting, then the exact G2 run occurs, and only afterward may V2-governed merges proceed.
